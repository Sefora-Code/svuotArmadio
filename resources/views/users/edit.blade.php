...
@section('content')
    ...
    <form id="edit-user-form" action="{{ route('users.update', $user->id) }}" method="post" class="mb-0">
        {{ csrf_field() }}
	    {{ method_field('PUT') }}
        ...
        <div class="input-group mb-3">
            <input type="text" name="name"
                   ...
                   value="{{ $user->name }}" placeholder="{{ __('adminlte::adminlte.name') }}"
                   autofocus/>
        ...
        <div class="input-group mb-3">
            <input type="text" name="surname"
                   ...
                   value="{{ $user->surname }}" placeholder="{{ __('adminlte::adminlte.surname') }}"
                   autofocus/>
            <div class="input-group-append">
                <div class="input-group-text">
                    <span class="fas fa-user {{ config('adminlte.classes_auth_icon', '') }}"></span>
        ...
        <div class="input-group mb-3">
            <input type="text" name="address"
                   ...
                   value="{{ $user->address ?? '' }}" placeholder="{{ __('adminlte::adminlte.address') }}"
                   autofocus/>
            <div class="input-group-append">
                <div class="input-group-text">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="radio-one" name="type" class="custom-control-input"
                       value="customer" {{ $user->customer != '' ? 'checked' : ''}} required/>
            ...
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="radio-two" name="type" class="custom-control-input"
                       value="deliverer" {{ $user->employee != '' ? 'checked' : ''}} required/>
