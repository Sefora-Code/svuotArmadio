...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-6">
        <div class="card card-reg mx-auto">
                <div class="card-img-caption">
                    <a href="#">
                        <h3 class="card-text"> Cliente </h3>
                        <div class="overlay"><img class="card-img-top img-fluid" src="https://picsum.photos/seed/picsum/500/250"></div>
                    </a>
                </div>
            </div>
            </div>
            ...
            <!-- <form action="{{ $register_url }}" method="post">
                ...
                <div class="input-group mb-3">
                    <input type="text" name="address" class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}"
                        value="{{ old('address') }}" placeholder="{{ __('adminlte::adminlte.address') }}" autofocus>
                    <div class="input-group-append">
                        <div class="input-group-text">
